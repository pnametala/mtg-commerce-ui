...
export default function HomeDisplay(props: ICardDisplayProps) {
    ...
    return (
        <Card className={classes.root}>
            <CardHeader
                ...
                title={cardTitle(card.scryfallCard)}
                subheader={card.scryfallCard.set}
            />
            <CardMedia
                className={classes.media}
                image={card.scryfallCard.imageUris['small']}
            />
            <CardContent>
                <Typography variant="body2" color="textSecondary" component="p">
                    {card.scryfallCard.oracleText}
                </Typography>
            </CardContent>
